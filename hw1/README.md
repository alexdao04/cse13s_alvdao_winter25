...
This homework is due by *11:59pm on Tuesday, 21 January 2025*. The initial
version of the design doc is due by *11:59pm on Friday, 17 January 2025*, and
...
[its page on gitlab](https://git.ucsc.edu/ajrudnic/cse-13s-resources-winter-2025/).

This process will look like:

```
$ cd ~
$ git clone git@git.ucsc.edu:ajrudnic/cse-13s-resources-winter-2025.git
$ cd ~/cse13s_sammytheslug/hw1/
$ cp ~/cse-13s-resources-winter-2025/hw1/hw1.c .
```
...
git repository (and push!) by end-of-day on **Friday, 17 January 2025**. For
...
```
https://git.ucsc.edu/cse-13s-winter-2025/cse13s_sammytheslug/-/blob/main/hw1/DESIGN.md
```
...
helpful, and [those are here](https://git.ucsc.edu/ajrudnic/cse-13s-demos-winter-2025/-/tree/main/count_characters).
